...
<nav class="bg-black text-white sticky top-0 z-50 shadow-md">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-row-reverse justify-between items-center h-10">
            ...
            <!-- Mobile LEFT controls (wallet then menu at the edge) -->
            <div class="md:hidden flex items-center flex-row-reverse gap-3">
                @auth
                ...
                @endguest
                <button id="mobile-menu-button" class="text-white focus:outline-none" aria-label="القائمة">
