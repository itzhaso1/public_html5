<div class="sidebar">
    ...
    <div data-kt-menu-trigger="click"
         class="menu-item menu-accordion {{ is_active('admin.auctions.*') }}">
        <span class="menu-link {{ is_active('admin.auctions.*') }}">
            <span class="menu-icon"><i class="bi bi-hammer fs-2"></i></span>
            <span class="menu-title">مزادات الألعاب</span>
            <span class="menu-arrow"></span>
        </span>
        <div class="menu-sub menu-sub-accordion menu-active-bg">
            <div class="menu-item">
                <a class="menu-link {{ is_active('admin.auctions.index') }}" href="{{ route('admin.auctions.index') }}">
                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                    <span class="menu-title">قائمة المزادات</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ is_active('admin.auctions.create') }}" href="{{ route('admin.auctions.create') }}">
                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                    <span class="menu-title">إضافة مزاد</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ is_active('admin.auctions.subscriptions.*') }}" href="{{ route('admin.auctions.subscriptions.index') }}">
                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
                    <span class="menu-title">طلبات الاشتراك</span>
                </a>
            </div>
            <div class="menu-item">
                <a class="menu-link {{ is_active('admin.auctions.payment_methods.*') }}" href="{{ route('admin.auctions.payment_methods.index') }}">
                    <span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
